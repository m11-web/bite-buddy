...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Order fast food from your nearest Spicy Bite branch — pizzas, burgers, wings, and more." },
      { name: "author", content: "Spicy Bite" },
      { property: "og:title", content: "Spicy Bite — Bite That Hits Different" },
      { property: "og:description", content: "Order fast food from your nearest Spicy Bite branch." },
